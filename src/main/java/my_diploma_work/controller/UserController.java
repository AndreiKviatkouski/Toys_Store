...
public class UserController {
    ...
    public String add(Model model) {
        User admin = new User(1, "Admin", "Adminski", "admin", "admin@mail.ru", "+375-29-111-11-11", ADMINISTRATOR);
        User userNew = new User(2, "User", "Userski", "user", "user@mail.ru", "+375-29-111-11-12", USER);
